...
import ma.zs.commun.zynerator.exception.EntityNotFoundException;
import ma.zs.commun.zynerator.history.HistBusinessObject;
import ma.zs.commun.zynerator.history.HistCriteria;
import ma.zs.commun.zynerator.repository.AbstractHistoryRepository;
import ma.zs.commun.zynerator.security.bean.User;
import ma.zs.commun.zynerator.security.service.facade.UserService;
import ma.zs.commun.zynerator.specification.AbstractHistorySpecification;
import ma.zs.commun.zynerator.util.RefelexivityUtil;
import ma.zs.commun.zynerator.util.StringUtil;
