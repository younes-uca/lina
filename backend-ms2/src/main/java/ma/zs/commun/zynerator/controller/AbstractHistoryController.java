package ma.zs.commun.zynerator.controller;

import jakarta.servlet.http.HttpServletRequest;
import ma.zs.commun.zynerator.audit.AuditBusinessObject;
import ma.zs.commun.zynerator.converter.AbstractConverter;
import ma.zs.commun.zynerator.criteria.BaseCriteria;
import ma.zs.commun.zynerator.dto.BaseDto;
import ma.zs.commun.zynerator.dto.FileTempDto;
import ma.zs.commun.zynerator.exception.BusinessRuleException;
import ma.zs.commun.zynerator.exception.GlobalException;
import ma.zs.commun.zynerator.export.ExportModel;
import ma.zs.commun.zynerator.service.IService;
import ma.zs.commun.zynerator.util.*;
