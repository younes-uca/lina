package  ma.zs.commun.ws.converter.commun;
...
import ma.zs.commun.zynerator.util.DateUtil;
...
public class ClientConverter extends AbstractConverter<Client, ClientDto> {
    ...
    public Client toItem(ClientDto dto) {
        ...
        Client item = new Client();
            ...
            if(this.categorieClient && dto.getCategorieClient()!=null &&  dto.getCategorieClient().getId() != null)
