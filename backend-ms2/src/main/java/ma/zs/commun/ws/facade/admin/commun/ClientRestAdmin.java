package  ma.zs.commun.ws.facade.admin.commun;
...
import ma.zs.commun.zynerator.controller.AbstractController;
import ma.zs.commun.zynerator.dto.AuditEntityDto;
import ma.zs.commun.zynerator.util.PaginatedList;
...
import ma.zs.commun.zynerator.process.Result;


import org.springframework.web.multipart.MultipartFile;
import ma.zs.commun.zynerator.dto.FileTempDto;
...
public class ClientRestAdmin  extends AbstractController<Client, ClientDto, ClientCriteria, ClientAdminService, ClientConverter> {
    ...
    @Operation(summary = "find by categorieClient id")
    @GetMapping("categorieClient/id/{id}")
    public List<ClientDto> findByCategorieClientId(@PathVariable Long id){
        return findDtos(service.findByCategorieClientId(id));
    }
    @Operation(summary = "delete by categorieClient id")
    @DeleteMapping("categorieClient/id/{id}")
    public int deleteByCategorieClientId(@PathVariable Long id){
        return service.deleteByCategorieClientId(id);
    }
