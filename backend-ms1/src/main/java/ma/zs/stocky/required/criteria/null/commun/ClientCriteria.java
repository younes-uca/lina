package  ma.zs.stocky.required.criteria.commun;
...
public class ClientCriteria extends BaseCriteria {
    ...
    private CategorieClientCriteria categorieClient ;
    private List<CategorieClientCriteria> categorieClients ;
    ...
    public CategorieClientCriteria getCategorieClient(){
        return this.categorieClient;
    }

    public void setCategorieClient(CategorieClientCriteria categorieClient){
        this.categorieClient = categorieClient;
    }
    public List<CategorieClientCriteria> getCategorieClients(){
        return this.categorieClients;
    }

    public void setCategorieClients(List<CategorieClientCriteria> categorieClients){
